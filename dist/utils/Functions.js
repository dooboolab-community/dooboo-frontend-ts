const getWorldTime = (tzOffset) => {
    ...
    const s = leadingZeros(now.getFullYear(), 4) + '-' +
...
export { getWorldTime, getStorage, setStorage, destroyStorage, getSessionStorage, setSessionStorage, destroySessionStorage, checkImageExists, };
